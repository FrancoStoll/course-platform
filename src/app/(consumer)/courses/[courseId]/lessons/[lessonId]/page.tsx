...
import YoutubeVideo from "@/features/lessons/components/YoutubeVideo";
import { getLessonIdTag } from "@/features/lessons/db/cache/lesson.cache.";
import { getUserLessonCompleteIdTag } from "@/features/lessons/db/cache/userLessonComplete.cache";
import {
  canViewLesson,
  wherePublicLessons,
} from "@/features/lessons/permissions/lesson.permissions";
  ...
  return (
    <div className="my-4 flex flex-col gap-4">
      <div className="aspect-video">
        {canView ? (
          <YoutubeVideo
            videoId={lesson.youtubeVideoUrl!}
            onFinishedVideo={
      ...
      <div className="flex flex-col gap-2">
        ...
        {canView ? (
          ...
          <p>This lesson is locked. Please purchase the course yo view it</p>
        )}
      </div>
    </div>
  );
